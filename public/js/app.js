...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Register__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Register */ "./resources/js/components/Register.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Register',
  components: {
    BaseInput: _BaseInput__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      errors: [],
  ...
  methods: {
    checkForm: function checkForm() {
      ...
      if (!this.errors.length) {
        ...
        _services_API__WEBPACK_IMPORTED_MODULE_0__["default"].put('register', this.user).then(function (response) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("input", {
    attrs: { type: _vm.type, placeholder: _vm.placeholderTxt }
  })
}
var staticRenderFns = []
render._withStripped = true
...
var render = function() {
  ...
  return _c("div", { staticClass: "home" }, [
    _c(
      "div",
      { staticClass: "home__content-container" },
      _vm._l(_vm.buttons, function(btn, index) {
        return _c(
          "div",
          { staticClass: "flex flex-col w-full text-xl" },
          [
            !btn.isActive
              ? _c("BaseButton", {
                  key: btn.name,
                  staticClass: "w-1/4 mx-auto",
                  attrs: { btnClass: btn.class, btnText: btn.name },
                  on: {
            ...
            _vm._v(" "),
            btn.isActive
              ? _c(btn.name, { key: btn.name, tag: "component" })
              : _vm._e()
          ],
          1
        )
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "register p-8 flex text-center mx-auto flex-col w-1/4" },
    [
      _c("h1", { staticClass: "text-4xl mb-3 text-center text-white" }, [
        _vm._v("Register")
      ]),
      _vm._v(" "),
      _c("transition", { attrs: { name: "fade" } }, [
        _vm.errors.length
          ? _c("div", { staticClass: "text-white text-base" }, [
      ...
      _vm._v(" "),
      _vm._l(_vm.formInputs, function(formInput) {
        return _c(
          "div",
          [
            _c("BaseInput", {
              staticClass: "px-1 my-1 w-full",
              attrs: {
      ...
      _c(
        "button",
        { staticClass: "my-1 text-white", on: { click: _vm.checkForm } },
        [_vm._v("Register\n    ")]
      )
    ],
    2
...
/* harmony import */ var _utils_appLauncher__WEBPACK_IMPORTED_MODULE_128__ = __webpack_require__(/*! ./utils/appLauncher */ "./resources/js/utils/appLauncher.js");
/* harmony import */ var _components_Home__WEBPACK_IMPORTED_MODULE_129__ = __webpack_require__(/*! ./components/Home */ "./resources/js/components/Home.vue");
/* harmony import */ var _components_Register__WEBPACK_IMPORTED_MODULE_130__ = __webpack_require__(/*! ./components/Register */ "./resources/js/components/Register.vue");
/* harmony import */ var _components_Login__WEBPACK_IMPORTED_MODULE_131__ = __webpack_require__(/*! ./components/Login */ "./resources/js/components/Login.vue");
...
Object(_utils_appLauncher__WEBPACK_IMPORTED_MODULE_128__["default"])({
  components: {
    Home: _components_Home__WEBPACK_IMPORTED_MODULE_129__["default"],
    Register: _components_Register__WEBPACK_IMPORTED_MODULE_130__["default"],
    Login: _components_Login__WEBPACK_IMPORTED_MODULE_131__["default"]
  }
});
 ...
 * Browser Check
 */
// import './vendor/setBrowserClasses';
 ...
 */
// require('axios').defaults.headers.common = {
...
/**
 * Require basic global components that needs to run everywhere
 */
...
/***/ "./resources/js/utils/DOMhelpers.js":
/*!******************************************!*\
  !*** ./resources/js/utils/DOMhelpers.js ***!
  \******************************************/
/*! exports provided: querySelector, addEventListener, scrollToTop */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/js/utils/appLauncher.js":
/*!*******************************************!*\
  !*** ./resources/js/utils/appLauncher.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return appLauncher; });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Appconfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Appconfig */ "./resources/js/Appconfig.js");
/* harmony import */ var _helpers_DOMhelpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @helpers/DOMhelpers */ "./resources/js/utils/DOMhelpers.js");
...
function appLauncher() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$destroyed = _ref.destroyed,
      destroyed = _ref$destroyed === void 0 ? null : _ref$destroyed,
      _ref$data = _ref.data,
      ...
      plugins = _ref$plugins === void 0 ? undefined : _ref$plugins,
      _ref$globalComponents = _ref.globalComponents,
      globalComponents = _ref$globalComponents === void 0 ? undefined : _ref$globalComponents;

  if (Object(_helpers_DOMhelpers__WEBPACK_IMPORTED_MODULE_2__["querySelector"])(_Appconfig__WEBPACK_IMPORTED_MODULE_1__["default"].vue.APP_CONTAINER_ID)) {
    // Install Vue Plugins if available
    // Vue.config.devtools = true;
    !!plugins && installPlugins(plugins); // Install Vue Components globally if available

    !!globalComponents && registerComponentsGlobally(globalComponents);
    new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
      name: _Appconfig__WEBPACK_IMPORTED_MODULE_1__["default"].vue.APP_NAME,
      store: store,
      router: router,
      ...
      render: render
    }).$mount(_Appconfig__WEBPACK_IMPORTED_MODULE_1__["default"].vue.APP_CONTAINER_ID);
  }
}

function installPlugins() {
  var pluginArray = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : isRequired();
  pluginArray.forEach(function (plugin) {
    return vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(plugin);
  });
}

function registerComponentsGlobally() {
  var componentsArray = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : isRequired();
...
__webpack_require__(/*! /Users/anjawodrich/workspace/myokrs/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/anjawodrich/workspace/myokrs/resources/sass/app.scss */"./resources/sass/app.scss");
